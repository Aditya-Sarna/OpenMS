...
namespace
{
                                 ...
                                 int indent)
  {
    ...
    os << pad << "\t<cvParam accession=\"IMS:1000102\" name=\"external offset\" value=\"" << offset << "\"/>\n";
    os << pad << "\t<cvParam accession=\"IMS:1000103\" name=\"external array length\" value=\"" << count << "\"/>\n";
    os << pad << "\t<cvParam accession=\"IMS:1000104\" name=\"external encoded length\" value=\"" << encoded << "\"/>\n";
    os << pad << "\t<binary/>\n";
                      ...
                      bool continuous)
  {
    ...
    os << "\t<fileDescription>\n";
    os << "\t\t<fileContent>\n";
    os << "\t\t\t<cvParam accession=\"IMS:1000080\" name=\"universally unique identifier\" value=\"" << XMLHandler::writeXMLEscape(uuid) << "\"/>\n";
    if (!ibd_md5.empty())
    {
      os << "\t\t\t<cvParam accession=\"IMS:1000090\" name=\"ibd MD5\" value=\"" << ibd_md5 << "\"/>\n";
    }
    os << "\t\t\t<cvParam accession=\"" << mode_acc << "\" name=\"" << mode_name << "\" value=\"\"/>\n";
    os << "\t\t\t<cvParam accession=\"MS:1000294\" name=\"mass spectrum\" value=\"\"/>\n";
    os << "\t\t</fileContent>\n";
    os << "\t</fileDescription>\n";
    os << "\t<referenceableParamGroupList count=\"2\">\n";
    os << "\t\t<referenceableParamGroup id=\"mzArray\">\n";
    os << "\t\t\t<cvParam accession=\"MS:1000514\" name=\"m/z array\" value=\"\"/>\n";
    os << "\t\t\t<cvParam accession=\"MS:1000521\" name=\"32-bit float\" value=\"\"/>\n";
    os << "\t\t\t<cvParam accession=\"IMS:1000101\" name=\"external data\" value=\"true\"/>\n";
    os << "\t\t</referenceableParamGroup>\n";
    os << "\t\t<referenceableParamGroup id=\"intensityArray\">\n";
    os << "\t\t\t<cvParam accession=\"MS:1000515\" name=\"intensity array\" value=\"\"/>\n";
    os << "\t\t\t<cvParam accession=\"MS:1000521\" name=\"32-bit float\" value=\"\"/>\n";
    os << "\t\t\t<cvParam accession=\"IMS:1000101\" name=\"external data\" value=\"true\"/>\n";
    os << "\t\t</referenceableParamGroup>\n";
    ...
    os << "\t\t\t<cvParam accession=\"MS:1000799\" name=\"custom unreleased software tool\" value=\"OpenMS\"/>\n";
    os << "\t\t</software>\n";
    os << "\t</softwareList>\n";
    ...
    {
      os << "\t\t\t<cvParam accession=\"IMS:1000042\" name=\"max count of pixels x\" value=\"" << meta.max_count_x << "\"/>\n";
    }
    if (meta.max_count_y > 0)
    {
      os << "\t\t\t<cvParam accession=\"IMS:1000043\" name=\"max count of pixels y\" value=\"" << meta.max_count_y << "\"/>\n";
    }
    if (meta.max_dim_x > 0)
    {
      os << "\t\t\t<cvParam accession=\"IMS:1000044\" name=\"max dimension x\" value=\"" << meta.max_dim_x
         << "\" unitCvRef=\"UO\" unitAccession=\"UO:0000017\" unitName=\"micrometer\"/>\n";
    }
    if (meta.max_dim_y > 0)
    {
      os << "\t\t\t<cvParam accession=\"IMS:1000045\" name=\"max dimension y\" value=\"" << meta.max_dim_y
         << "\" unitCvRef=\"UO\" unitAccession=\"UO:0000017\" unitName=\"micrometer\"/>\n";
    }
    if (meta.pixel_size_x > 0)
    {
      os << "\t\t\t<cvParam accession=\"IMS:1000046\" name=\"pixel size x\" value=\"" << meta.pixel_size_x
         << "\" unitCvRef=\"UO\" unitAccession=\"UO:0000017\" unitName=\"micrometer\"/>\n";
    }
    if (meta.pixel_size_y > 0)
    {
      os << "\t\t\t<cvParam accession=\"IMS:1000047\" name=\"pixel size y\" value=\"" << meta.pixel_size_y
         << "\" unitCvRef=\"UO\" unitAccession=\"UO:0000017\" unitName=\"micrometer\"/>\n";
    }
    os << "\t\t</scanSettings>\n";
    os << "\t</scanSettingsList>\n";
    ...
    os << "\t\t\t<cvParam accession=\"MS:1000031\" name=\"instrument model\" value=\"OpenMS export\"/>\n";
    ...
    os << "\t\t\t\t<cvParam accession=\"MS:1000544\" name=\"Conversion to imzML\" value=\"\"/>\n";
    os << "\t\t\t</processingMethod>\n";
    os << "\t\t</dataProcessing>\n";
    os << "\t</dataProcessingList>\n";
    os << "\t<run defaultInstrumentConfigurationRef=\"IC1\">\n";
    ...
    for (Size i = 0; i < exp.size(); ++i)
    {
      ...
      os << "\t\t\t\t<scanList count=\"1\">\n";
      os << "\t\t\t\t\t<cvParam accession=\"MS:1000795\" name=\"no combination\" value=\"\"/>\n";
      os << "\t\t\t\t\t<scan instrumentConfigurationRef=\"IC1\">\n";
      os << "\t\t\t\t\t\t<cvParam accession=\"IMS:1000050\" name=\"position x\" value=\"" << plan.pixel.x << "\"/>\n";
      os << "\t\t\t\t\t\t<cvParam accession=\"IMS:1000051\" name=\"position y\" value=\"" << plan.pixel.y << "\"/>\n";
      os << "\t\t\t\t\t\t<cvParam accession=\"IMS:1000052\" name=\"position z\" value=\"" << plan.pixel.z << "\"/>\n";
      os << "\t\t\t\t\t</scan>\n";
      os << "\t\t\t\t</scanList>\n";
